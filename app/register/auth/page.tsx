...
export default function RegisterAuthPage() {
  ...
  // 💡 研究室で決める暗証番号（例として「1234」に設定しています）
    ...
    <main className="p-6 max-w-md mx-auto h-screen flex flex-col justify-center">
      <div className="border border-gray-200 p-6 rounded-xl shadow-md bg-white">
        ...
        <p className="text-sm text-gray-600 mb-6">
          新しい本を登録するには、研究室の管理暗証番号を入力してください。
        </p>
        ...
        <form onSubmit={handleVerify} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="••••"
              className="w-full px-4 py-3 border border-gray-300 rounded-md text-center text-2xl tracking-widest focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900"
              maxLength={4}
            />
